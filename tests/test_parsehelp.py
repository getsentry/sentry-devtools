...
from devtools.internal import parsehelp as args
from devtools.internal.parsehelp import ParseError
from devtools.lib.modules import ArgArgs
...
def test_parse_alias() -> None:
    ...
    with pytest.raises(ParseError):
        args.generate("-d , --dog-food, -c   Selects the d option")
